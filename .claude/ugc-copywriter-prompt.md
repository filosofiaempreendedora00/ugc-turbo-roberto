# Prompt — Especialista em Copy UGC de Alta Conversão
...
**face_to_camera**: Direto, pessoal, intimate. A pessoa fala como se fosse um desabafo ou conselho para uma amiga. Tom confessional.
